        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <img src="<?= base_url('foto') ?>/sentani-asei.jpg" width="650px">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                    ...
                    <ul>
                        <li><i class="bi bi-check-circle"></i>Selamat datang di [Nama Perusahaan],
                            tempat di mana inovasi bertemu dengan komitmen untuk menyediakan solusi terbaik bagi Anda.
                            Kami berdedikasi untuk membantu Anda mencapai tujuan melalui produk dan layanan berkualitas tinggi, dengan pendekatan yang didorong oleh integritas dan keahlian.</li>
                        <li><i class="bi bi-check-circle"></i> Selamat datang di [Nama Perusahaan],
                            tempat di mana inovasi bertemu dengan komitmen untuk menyediakan solusi terbaik bagi Anda.
                            Kami berdedikasi untuk membantu Anda mencapai tujuan melalui produk dan layanan berkualitas tinggi, dengan pendekatan yang didorong oleh integritas dan keahlian.</li>
                        <li><i class="bi bi-check-circle"></i> Selamat datang di [Nama Perusahaan],
