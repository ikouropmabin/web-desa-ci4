...
class Session implements SessionInterface
{
    ...
    public function __construct(SessionHandlerInterface $driver, SessionConfig $config)
    {
        ...
        $this->cookie = (new Cookie($this->config->cookieName, '', [
            ...
            'samesite' => $cookie->samesite ?? \CodeIgniter\Cookie\CookieInterface::SAMESITE_LAX,
    ...
    protected function configure()
    {
        ...
        $sameSite = $this->cookie->getSameSite() ?: ucfirst(\CodeIgniter\Cookie\CookieInterface::SAMESITE_LAX);
